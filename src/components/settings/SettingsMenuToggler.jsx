...
function SettingsMenuToggler(props) {
    ...
    useEffect(() => {
        if (props.showSettings == true) {
            ...
            setIcon(<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
    ...
    return (
        <div className="settings-menu-toggler-container">
            <button className="settings-menu-toggler" onClick={handleClick}>{icon}</button>
        </div>
    );
}
