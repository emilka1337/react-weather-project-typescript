...
import { useStarredCitiesStore } from "./starredCitiesStore";
import { useForecastModeStore } from "./forecastModeStore";
...
describe("starredCitiesStore", () => {
    ...
    it("drops corrupted saved cities instead of throwing at import", async () => {
        ...
        const store = (await import("./starredCitiesStore")).useStarredCitiesStore;
